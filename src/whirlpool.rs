...
fn process_buffer(hash: &mut [u64; 8], buffer: &[u8]) {
    let mut k: [u64; 8] = unsafe { std::mem::MaybeUninit::uninit().assume_init() };
    let mut block: [u64; 8] = unsafe { std::mem::MaybeUninit::uninit().assume_init() };
    let mut state: [u64; 8] = unsafe { std::mem::MaybeUninit::uninit().assume_init() };
    let mut l: [u64; 8] = unsafe { std::mem::MaybeUninit::uninit().assume_init() };
